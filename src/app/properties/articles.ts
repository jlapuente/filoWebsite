...
export class ARTICLES {
  static readonly articuloPiePagina: Article = new Article('Javier Lapuente', 'Guia de Word 01', 'Como citar a pie de pagina', 'Sat Feb 13 2021 12:19:12',
    ...
    '</p><div class="videoContainer"><iframe width="100%" height="100%" src="https://www.youtube.com/embed/AM2KumCYj_k" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>', '0')
